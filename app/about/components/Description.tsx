  ...
  return (
    <div className="w-full self-end mt-10 md:mb-auto md:mt-0 md:w-3/5">
      ...
      <section className="text-left mb-8">
        <h2 className="text-2xl font-semibold mb-4 pb-3 border-b text-blue-700">Educations</h2>
      ...
      <section className="text-left">
        <h2 className="text-2xl font-semibold mb-4 pb-3 border-b text-blue-700">Experience</h2>
